...
function renderizarDadosUsuario(dados) {
    ...
    let urlImage = dados.resultado[0].imagem.grande
    let userName = `${dados.resultado[0].nome.primeiro} ${dados.resultado[0].nome.utlimo}`
    let userEmail = dados.resultado[0].email
